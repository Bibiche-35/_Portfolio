...
<main class="container">
			...
			<div class="main">
				...
				<ul class="caminho">
					...
					<li> > </li>
					<li><H1>COMMUNICATION EN SANTÉ</H1></li>
				</ul>
				...
				<H2>Bande annonce visionnée sur VIMEO (10 600 fois en fr et 700 fois en VI), Film visionné sur VIMEO (plus de 14 000 fois et 45 projections-débats ont été organisées en france et dom-Tom entre Janvier 2019 et Avril 2020). </br>
				Démarche en cours avec une version international du film : Inscription à des congrès médicaux et festivals de film sport et santé.</br></H2>
				</div>
